    ...
    public static void main(String[] args) {
      ...
      //  baslangiciAYadaSonuNOlaniSil(liste);
       // uzunlugu8ile10arasiveOIleBiteniSil(liste);
        ...
        System.out.println("xIleBasliyormu(liste) = " + xIleBasliyormu(liste));
...
//    }
    ...
    public static void uzunlugaGoreTersYazdir(List<String> list){
        list.stream().sorted().sorted(Comparator.comparing(String::length).reversed()).forEach(Utils::ayniSatirdaBosluklaYazdir);
    }
