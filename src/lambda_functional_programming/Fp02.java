...
public class Fp02 {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println("tekrarsiz cift elemanlarin toplami");
    ...
    public static void tekrarsizCiftElemanlarinKareToplami01(List<Integer> list) {
        ...
        public static void tekrarsizCiftElemanlarinKareToplami02(List<Integer>list){
            ...
            System.out.println(list.stream().distinct().filter(Utils::ciftElemaniSec).map(Utils::karesinAl).reduce(Math::addExact).get());
    ...
    public static void yedidenBuyukCiftMin(List<Integer> list){
      Integer min =  list.stream().filter(Utils::ciftElemaniSec).filter(t->t>7).reduce(Math::min).get();
        System.out.println(min);
    }
