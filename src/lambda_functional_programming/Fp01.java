...
public class Fp01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        listElemanlariniYazdirStructured01(liste);
        System.out.println();
        ciftElemanlariYazdir(liste);
        System.out.println();
        ciftElemanlariYazdir01(liste);
        System.out.println();
        tekSayilarinKareleri(liste);
        System.out.println();
        tekrarsizTekSayilarinKupleri(liste);
        System.out.println();
        tekrarsizCiftSayilarinKareleriToplami(liste);
        tekrarsizCiftSayilarinKuplerininToplami(liste);
    ...
    public static void listElemanlariniYazdirStructured01(List<Integer> list){
    ...
    public static void ciftElemanlariYazdir01(List<Integer> list){
    ...
    public static void tekSayilarinKareleri(List<Integer> list){
    ...
    public static void tekrarsizTekSayilarinKupleri(List<Integer> list){
        list.stream().distinct().filter(t->t%2!=0).map(t->t*t*t).forEach(t-> System.out.print(t+" "));

    }

    //5) Tekrarsız çift elemanların karelerinin toplamını hesaplayan bir method oluşturun.
    public static void tekrarsizCiftSayilarinKareleriToplami(List<Integer> list){
     Integer carpim =   list.stream().distinct().filter(t->t%2==0).map(t->t*t).reduce((t,u)->t*u).get();
        System.out.println(carpim);
    }
    //6) Tekrarsız çift elemanların küpünün çarpımını hesaplayan bir method oluşturun.
    public static void tekrarsizCiftSayilarinKuplerininToplami(List<Integer> list){
      Integer carpim =  list.stream().distinct().filter(t->t%2==0).map(t->t*t*t).reduce((t,u)->t*u).get();
        System.out.println(carpim);
    }
    ...
    public static void getMinEleman02(List<Integer> list){
      Optional<Integer> min = list.stream().distinct().sorted().reduce(Math::min);
