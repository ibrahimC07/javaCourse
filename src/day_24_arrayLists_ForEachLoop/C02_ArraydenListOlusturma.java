...
public class C02_ArraydenListOlusturma {
    public static void main(String[] args) {
        ...
        listede var olup olmadigini kullancya yazalim
         */
        ...
        while (!bildiMi){ // bildimi==false
            ...
            sayi=scan.nextInt();
            if (sayiListesi.contains(sayi)){
                System.out.println("Tebrikler " + tahminSayisi+ " adet tahminde bulundunuz listede bir sayi buldunuz");
                bildiMi=true;
            }else System.out.println(tahminSayisi+ " adet sayi soylediniz ama hicbiri listede yok");
            tahminSayisi++;
