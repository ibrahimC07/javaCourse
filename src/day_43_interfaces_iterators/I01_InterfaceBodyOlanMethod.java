package day_43_interfaces_iterators;
...
public interface I01_InterfaceBodyOlanMethod {
    ...
    O zaman nicin 2 keyword (static ve defau
    child class'lardan bu method'a nasil erisilebilecegini belirlemek icindir
    static keyword kullanlt) tanimlanmistir ?
    Bu iki farkli kelimenin amaciilirsa , child class'dan bu method'a erismek icin
