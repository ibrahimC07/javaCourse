package day_29_passByValue_immutable;
...
public class C01_PassByValue {
    public static void main(String[] args) {
        ...
        // Java creates copy of values i method calls to protect original value of the variable
        // java use passbyvalue some programming language may use pass by reference
         /*
