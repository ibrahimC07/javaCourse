...
public class C04_MethodCreationReturn {
    // verilen isim ve soyismi ilk harfi buyuk geriye kalanlari * olacak sekilde degistirip
    ...
    public static void main(String[] args) {
       ...
       String tersYazilis= gizliIsim(isim,soyisim);
        System.out.println(isim+" "+soyisim);
        System.out.println(tersYazilis);
    }
